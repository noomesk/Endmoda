        ...
        <div ref={contentRef} className="p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <button 
                className="w-8 h-8 border border-gray-600 rounded-full flex items-center justify-center hover:border-luxury-accent hover:text-luxury-accent transition-colors duration-300"
